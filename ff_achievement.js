...
//Rewarding failure is patronizing
/*
...
FF_Achievement.getCurrentTimeAchievements = function() {
 return [
	new FF_Achievement(100, "Survivor", "Play for 1 minute in a game", function(values) { return values.currentTime >=    6000; }),
	//new FF_Achievement(101, "Current Time 3", "Play for 3 minutes in a game", function(values) { return values.currentTime >=  18000; }),
	new FF_Achievement(102, "Straggler", "Play for 10 minutes in a game", function(values) { return values.currentTime >= 60000; }),
  ];
}
...
FF_Achievement.getCurrentDistanceAchievements = function() {
 return [
  new FF_Achievement(0, "First Flight", "Fly 1000 meters in a game"  , function(values) { return values.currentDistance >=   100000; }),
	new FF_Achievement(1, "Journeyman", "Fly 2500 meters in a game"  , function(values) { return values.currentDistance >=   250000; }),
	new FF_Achievement(2, "City of Neon Light", "Fly 5000 meters in a game"  , function(values) { return values.currentDistance >=   500000; }),
	new FF_Achievement(3, "The lines at the end of the tunnel", "Fly 10000 meters in a game" , function(values) { return values.currentDistance >=  1000000; }),
  ];
}
...
FF_Achievement.getSpeedStartAchievements = function() {
 return [
   ...
   //yes, this IS possible 
    new FF_Achievement(606, "Sanic Boom", "Fly 1500 meters in 10 seconds", function(values) { return values.currentDistance >= 150000; }) 
  ];
}
